...
################### Train and Test Data for cartedian and polar normalized GPs
...
########################### skyscan.lib GP Model Squared Exponential ########################
...
mean_std_pred_incloud2 = np.mean(np.sqrt(var_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5]))
rmse_incloud2 = np.sqrt(np.mean((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5])**2))

abs_error_incloud2 = np.abs(zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5])
std_pred_incloud2 = np.sqrt(var_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5])
test_std_soundness_incloud2 = (std_pred_incloud2-abs_error_incloud2)/std_pred_incloud2

std_pred_soundness_incloud2 = np.array([np.percentile(test_std_soundness_incloud2,0.3),np.percentile(test_std_soundness_incloud2,5),
np.percentile(test_std_soundness_incloud2,32)])


explained_variance = np.sum((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5] -
                    mean_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5])**2)
total_variance = np.sum((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]- zwind_train.mean())**2)
r2_incloud2 = 1 - explained_variance/total_variance

error_incloud2 = zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred2[lwc_cloud[4,zind_rel[zi]]>=1e-5]
error_stats_incloud2 = np.array([np.mean(error_incloud2),np.median(error_incloud2),np.std(error_incloud2),skew(error_incloud2)])

error_incloud2_total = zwind_data[4,zind_rel[zi]]-mean_pred2
...
mean_std_pred_incloud3 = np.mean(np.sqrt(var_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5]))
rmse_incloud3 = np.sqrt(np.mean((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5])**2))

abs_error_incloud3 = np.abs(zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5])
std_pred_incloud3 = np.sqrt(var_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5])
test_std_soundness_incloud3 = (std_pred_incloud3-abs_error_incloud3)/std_pred_incloud3

std_pred_soundness_incloud3 = np.array([np.percentile(test_std_soundness_incloud3,0.3),np.percentile(test_std_soundness_incloud3,5),
np.percentile(test_std_soundness_incloud3,32)])


explained_variance = np.sum((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5] -
                    mean_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5])**2)
total_variance = np.sum((zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]- zwind_train.mean())**2)
r2_incloud3 = 1 - explained_variance/total_variance

error_incloud3 = zwind_data[4,zind_rel[zi]][lwc_cloud[4,zind_rel[zi]]>=1e-5]-mean_pred3[lwc_cloud[4,zind_rel[zi]]>=1e-5]
error_stats_incloud3 = np.array([np.mean(error_incloud3),np.median(error_incloud3),np.std(error_incloud3),skew(error_incloud3)])

error_incloud3_total = zwind_data[4,zind_rel[zi]]-mean_pred3
...
im4 = axarr[2,3].imshow(error_incloud3_total[:,30:].T,origin='lower',extent=[xr[0], xr[-1], yr[30], yr[-1]],vmin=-1.5,vmax=1.5)
